...
The body is just the code which will be executed: this sits between the curly brackets.
...
A **functional** is any function that takes a function as an
...
Creating R packages is a big topic --- too big to cover in a single session --- but you can read more about it in Hadley Wickham and Jenny Bryan's book [R Packages](https://r-pkgs.org/index.html).
